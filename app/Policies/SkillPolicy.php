...
class SkillPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-skill') && $user->id == $skill->user_id;
    }
    ...
    {
        return $user->hasPermissionTo('create-skill');
    }
    ...
    {
        return $user->hasPermissionTo('update-skill') && $user->id == $skill->user_id;
    }
    ...
    {
        return $user->hasPermissionTo('delete-skill') && $user->id == $skill->user_id;
    }
